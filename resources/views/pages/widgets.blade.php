                ...
                <div class="col-md-2 col-sm-4">
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <div class="text-value-lg py-3">1,123</div>
                            <div class="chart-wrapper mx-auto" style="height:40px;width:80px">
                                <canvas class="chart chart-line" id="sparkline-chart-4" height="40"
                                        width="100"></canvas>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-2 col-sm-4">
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <div class="text-value-lg py-3">1,123</div>
                            <div class="chart-wrapper mx-auto" style="height:40px;width:80px">
                                <canvas class="chart chart-line" id="sparkline-chart-5" height="40"
                                        width="100"></canvas>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-2 col-sm-4">
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <div class="text-value-lg py-3">1,123</div>
                            <div class="chart-wrapper mx-auto" style="height:40px;width:80px">
                                <canvas class="chart chart-line" id="sparkline-chart-6" height="40"
                                        width="100"></canvas>
                            </div>
                        </div>
                    </div>
