        ...
        <div class="card card-default">
            ...
            <div class="card-body">
                <div class="row text-center">
                    ...
                    <div class="col-6 col-sm-4 col-md-2">
                        <i
                            class="icons font-2xl d-block mt-5 cui-action-redo"
                        ></i>
                        <div>action-redo</div>
                    </div>
                    <div class="col-6 col-sm-4 col-md-2">
                        <i
                            class="icons font-2xl d-block mt-5 cui-action-undo"
                        ></i>
                        <div>action-undo</div>
                    </div>
                    <div class="col-6 col-sm-4 col-md-2">
                        <i
                            class="icons font-2xl d-block mt-5 cui-align-center"
                        ></i>
                        <div>align-center</div>
                    </div>
                    <div class="col-6 col-sm-4 col-md-2">
                        <i
                            class="icons font-2xl d-block mt-5 cui-align-left"
                        ></i>
                        <div>align-left</div>
                    </div>
                    <div class="col-6 col-sm-4 col-md-2">
                        <i
                            class="icons font-2xl d-block mt-5 cui-align-right"
                        ></i>
                        <div>align-right</div>
                    </div>
                    <div class="col-6 col-sm-4 col-md-2">
                        <i
                            class="icons font-2xl d-block mt-5 cui-arrow-bottom"
                        ></i>
                        <div>arrow-bottom</div>
                    </div>
                    <div class="col-6 col-sm-4 col-md-2">
                        <i
                            class="icons font-2xl d-block mt-5 cui-arrow-left"
                        ></i>
                        <div>arrow-left</div>
                    </div>
                    <div class="col-6 col-sm-4 col-md-2">
                        <i
                            class="icons font-2xl d-block mt-5 cui-arrow-right"
                        ></i>
                        <div>arrow-right</div>
                    </div>
                    <div class="col-6 col-sm-4 col-md-2">
                        <i
                            class="icons font-2xl d-block mt-5 cui-arrow-top"
                        ></i>
                        <div>arrow-top</div>
                    </div>
                    <div class="col-6 col-sm-4 col-md-2">
                    ...
                    <div class="col-6 col-sm-4 col-md-2">
                        <i
                            class="icons font-2xl d-block mt-5 cui-briefcase"
                        ></i>
                        <div>briefcase</div>
                    </div>
                    <div class="col-6 col-sm-4 col-md-2">
                    ...
                    <div class="col-6 col-sm-4 col-md-2">
                        <i
                            class="icons font-2xl d-block mt-5 cui-calculator"
                        ></i>
                        <div>calculator</div>
                    </div>
                    <div class="col-6 col-sm-4 col-md-2">
                    ...
                    <div class="col-6 col-sm-4 col-md-2">
                        <i
                            class="icons font-2xl d-block mt-5 cui-chevron-left"
                        ></i>
                    ...
                    <div class="col-6 col-sm-4 col-md-2">
                        <i
                            class="icons font-2xl d-block mt-5 cui-chevron-top"
                        ></i>
                        <div>chevron-top</div>
                    </div>
                    <div class="col-6 col-sm-4 col-md-2">
                        <i
                            class="icons font-2xl d-block mt-5 cui-circle-check"
                        ></i>
                    ...
                    <div class="col-6 col-sm-4 col-md-2">
                        <i
                            class="icons font-2xl d-block mt-5 cui-cloud-upload"
                        ></i>
                    ...
                    <div class="col-6 col-sm-4 col-md-2">
                        <i
                            class="icons font-2xl d-block mt-5 cui-credit-card"
                        ></i>
                        <div>credit-card</div>
                    </div>
                    <div class="col-6 col-sm-4 col-md-2">
                    ...
                    <div class="col-6 col-sm-4 col-md-2">
                        <i
                            class="icons font-2xl d-block mt-5 cui-dashboard"
                        ></i>
                        <div>dashboard</div>
                    </div>
                    <div class="col-6 col-sm-4 col-md-2">
                    ...
                    <div class="col-6 col-sm-4 col-md-2">
                        <i
                            class="icons font-2xl d-block mt-5 cui-justify-left"
                        ></i>
                    ...
                    <div class="col-6 col-sm-4 col-md-2">
                        <i
                            class="icons font-2xl d-block mt-5 cui-lightbulb"
                        ></i>
                        <div>lightbulb</div>
                    </div>
                    <div class="col-6 col-sm-4 col-md-2">
                    ...
                    <div class="col-6 col-sm-4 col-md-2">
                        <i
                            class="icons font-2xl d-block mt-5 cui-location-pin"
                        ></i>
                        <div>location-pin</div>
                    </div>
                    <div class="col-6 col-sm-4 col-md-2">
                        <i
                            class="icons font-2xl d-block mt-5 cui-lock-locked"
                        ></i>
                        <div>lock-locked</div>
                    </div>
                    <div class="col-6 col-sm-4 col-md-2">
                    ...
                    <div class="col-6 col-sm-4 col-md-2">
                        <i
                            class="icons font-2xl d-block mt-5 cui-paperclip"
                        ></i>
                        <div>paperclip</div>
                    </div>
                    <div class="col-6 col-sm-4 col-md-2">
                    ...
                    <div class="col-6 col-sm-4 col-md-2">
                        <i
                            class="icons font-2xl d-block mt-5 cui-pie-chart"
                        ></i>
                        <div>pie-chart</div>
                    </div>
                    <div class="col-6 col-sm-4 col-md-2">
                    ...
                    <div class="col-6 col-sm-4 col-md-2">
                        <i
                            class="icons font-2xl d-block mt-5 cui-speedometer"
                        ></i>
                        <div>speedometer</div>
                    </div>
                    <div class="col-6 col-sm-4 col-md-2">
                    ...
                    <div class="col-6 col-sm-4 col-md-2">
                        <i
                            class="icons font-2xl d-block mt-5 cui-thumb-down"
                        ></i>
                        <div>thumb-down</div>
                    </div>
                    <div class="col-6 col-sm-4 col-md-2">
                    ...
                    <div class="col-6 col-sm-4 col-md-2">
                        <i
                            class="icons font-2xl d-block mt-5 cui-underline"
                        ></i>
                        <div>underline</div>
                    </div>
                    <div class="col-6 col-sm-4 col-md-2">
                    ...
                    <div class="col-6 col-sm-4 col-md-2">
                        <i
                            class="icons font-2xl d-block mt-5 cui-user-female"
                        ></i>
                        <div>user-female</div>
                    </div>
                    <div class="col-6 col-sm-4 col-md-2">
                        <i
                            class="icons font-2xl d-block mt-5 cui-user-follow"
                        ></i>
                        <div>user-follow</div>
                    </div>
                    <div class="col-6 col-sm-4 col-md-2">
