        ...
        <div class="animated fadeIn">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-header-actions">
                        <a class="card-header-action"
                           href="http://coreui.io/docs/components/bootstrap-popover/popovers.html" target="_blank">
                ...
                <div class="card-body">
                    ...
                    <hr>
                    <a class="btn btn-lg btn-danger" tabindex="0" role="button" data-toggle="popover"
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <button class="btn btn-secondary" type="button" data-container="body" data-toggle="popover"
                            ...
                            data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">Popover on bottom
                    </button>
                    <button class="btn btn-secondary" type="button" data-container="body" data-toggle="popover"
                            data-placement="left"
