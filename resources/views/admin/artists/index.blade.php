...
<script>
    $(function () {
      ...
      let deleteButton = {
        ...
        url: "{{ route('api.artists.multiDelete') }}",
      ...
      let dtOverrideGlobals = {
        ...
        aaSorting: [],
        ajax: "{{ route('api.artists.dataTable') }}",
        columns: [
      ...
      let table = $('#artists_table').DataTable(dtOverrideGlobals);

      $('#artists_table tbody').on('click', 'tr td:not(:nth-child(1))', function () {
