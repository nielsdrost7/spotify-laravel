        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row align-items-center mt-3">
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-block btn-secondary active"
                            type="button"
                            aria-pressed="true"
                        >
                            Secondary
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-block btn-info active"
                            type="button"
                            aria-pressed="true"
                        >
                            Info
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-block btn-dark active"
                            type="button"
                            aria-pressed="true"
                        >
                            Dark
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row align-items-center">
                    ...
                    <div
                        class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0"
                    ></div>
                </div>
                <div class="row align-items-center mt-3">
                    <div class="col-12 col-xl mb-3 mb-xl-0">Active State</div>
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-block btn-outline-primary active"
                            type="button"
                            aria-pressed="true"
                        >
                            Primary
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-block btn-outline-secondary active"
                            type="button"
                            aria-pressed="true"
                        >
                            Secondary
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-block btn-outline-warning active"
                            type="button"
                            aria-pressed="true"
                        >
                            Warning
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-block btn-outline-danger active"
                            type="button"
                            aria-pressed="true"
                        >
                            Danger
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-block btn-ghost-primary"
                            type="button"
                        >
                            Primary
                        </button>
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-block btn-ghost-secondary"
                            type="button"
                        >
                            Secondary
                        </button>
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-block btn-ghost-success"
                            type="button"
                        >
                            Success
                        </button>
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-block btn-ghost-warning"
                            type="button"
                        >
                            Warning
                        </button>
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-block btn-ghost-light"
                            type="button"
                        >
                            Light
                        </button>
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-block btn-ghost-dark"
                            type="button"
                        >
                            Dark
                        </button>
                ...
                <div class="row align-items-center mt-3">
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-block btn-ghost-primary active"
                            type="button"
                            aria-pressed="true"
                        >
                            Primary
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-block btn-ghost-secondary active"
                            type="button"
                            aria-pressed="true"
                        >
                            Secondary
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-block btn-ghost-success active"
                            type="button"
                            aria-pressed="true"
                        >
                            Success
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-block btn-ghost-warning active"
                            type="button"
                            aria-pressed="true"
                        >
                            Warning
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-block btn-ghost-danger active"
                            type="button"
                            aria-pressed="true"
                        >
                            Danger
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-block btn-ghost-info active"
                            type="button"
                            aria-pressed="true"
                        >
                            Info
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-block btn-ghost-light active"
                            type="button"
                            aria-pressed="true"
                        >
                            Light
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-block btn-ghost-dark active"
                            type="button"
                            aria-pressed="true"
                        >
                            Dark
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-square btn-block btn-danger"
                            type="button"
                        >
                            Danger
                        </button>
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-square btn-block btn-info"
                            type="button"
                        >
                            Info
                        </button>
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-square btn-block btn-dark"
                            type="button"
                        >
                            Dark
                        </button>
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-square btn-block btn-link"
                            type="button"
                        >
                            Link
                        </button>
                ...
                <div class="row align-items-center mt-3">
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-square btn-block btn-success active"
                            type="button"
                            aria-pressed="true"
                        >
                            Success
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-square btn-block btn-warning active"
                            type="button"
                            aria-pressed="true"
                        >
                            Warning
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-square btn-block btn-info active"
                            type="button"
                            aria-pressed="true"
                        >
                            Info
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-square btn-block btn-light active"
                            type="button"
                            aria-pressed="true"
                        >
                            Light
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-square btn-block btn-dark active"
                            type="button"
                            aria-pressed="true"
                        >
                            Dark
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-square btn-block btn-link active"
                            type="button"
                            aria-pressed="true"
                        >
                            Link
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-pill btn-block btn-light"
                            type="button"
                        >
                            Light
                        </button>
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-pill btn-block btn-dark"
                            type="button"
                        >
                            Dark
                        </button>
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-pill btn-block btn-link"
                            type="button"
                        >
                            Link
                        </button>
                ...
                <div class="row align-items-center mt-3">
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-pill btn-block btn-primary active"
                            type="button"
                            aria-pressed="true"
                        >
                            Primary
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-pill btn-block btn-secondary active"
                            type="button"
                            aria-pressed="true"
                        >
                            Secondary
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-pill btn-block btn-warning active"
                            type="button"
                            aria-pressed="true"
                        >
                            Warning
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-pill btn-block btn-danger active"
                            type="button"
                            aria-pressed="true"
                        >
                            Danger
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-pill btn-block btn-info active"
                            type="button"
                            aria-pressed="true"
                        >
                            Info
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-pill btn-block btn-light active"
                            type="button"
                            aria-pressed="true"
                        >
                            Light
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-pill btn-block btn-dark active"
                            type="button"
                            aria-pressed="true"
                        >
                            Dark
                    ...
                    <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                        <button
                            class="btn btn-pill btn-block btn-link active"
                            type="button"
                            aria-pressed="true"
                        >
                            Link
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row align-items-center mt-3">
                    ...
                    <div class="col-6 col-sm-4 col-md mb-3 mb-xl-0 text-center">
                        <button
                            class="btn btn-lg btn-ghost-success"
                            type="button"
                        >
                            Ghost Button
                        </button>
                    ...
                    <div class="col-6 col-sm-4 col-md mb-3 mb-xl-0 text-center">
                        <button
                            class="btn btn-lg btn-square btn-warning"
                            type="button"
                        >
                            Square Button
                        </button>
                    ...
                    <div class="col-6 col-sm-4 col-md mb-3 mb-xl-0 text-center">
                        <button
                            class="btn btn-lg btn-pill btn-danger"
                            type="button"
                        >
                            Pill Button
                        </button>
