        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <label
                            class="switch switch-pill switch-outline-primary"
                        >
                            <input
                                class="switch-input"
                                type="checkbox"
                        ...
                        <label
                            class="switch switch-pill switch-outline-success"
                        >
                            <input
                                class="switch-input"
                                type="checkbox"
                        ...
                        <label
                            class="switch switch-pill switch-outline-warning"
                        >
                            <input
                                class="switch-input"
                                type="checkbox"
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <label
                            class="
                                switch switch-pill switch-outline-primary-alt
                            "
                        >
                            <input
                                class="switch-input"
                        ...
                        <label
                            class="
                                switch switch-pill switch-outline-secondary-alt
                            "
                        >
                            <input
                                class="switch-input"
                        ...
                        <label
                            class="
                                switch switch-pill switch-outline-success-alt
                            "
                        >
                            <input
                                class="switch-input"
                        ...
                        <label
                            class="
                                switch switch-pill switch-outline-warning-alt
                            "
                        >
                            <input
                                class="switch-input"
                        ...
                        <label
                            class="switch switch-pill switch-outline-info-alt"
                        >
                            <input
                                class="switch-input"
                                type="checkbox"
                        ...
                        <label
                            class="switch switch-pill switch-outline-danger-alt"
                        >
                            <input
                                class="switch-input"
                                type="checkbox"
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <label
                            class="
                                switch switch-label switch-pill switch-primary
                            "
                        >
                            <input
                                class="switch-input"
                        ...
                        <label
                            class="
                                switch switch-label switch-pill switch-secondary
                            "
                        >
                            <input
                                class="switch-input"
                        ...
                        <label
                            class="
                                switch switch-label switch-pill switch-warning
                            "
                        >
                            <input
                                class="switch-input"
                        ...
                        <label
                            class="switch switch-label switch-pill switch-info"
                        >
                            <input
                                class="switch-input"
                                type="checkbox"
                        ...
                        <label
                            class="
                                switch switch-label switch-pill switch-danger
                            "
                        >
                            <input
                                class="switch-input"
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <label
                            class="switch switch-label switch-outline-primary"
                        >
                            <input
                                class="switch-input"
                                type="checkbox"
                        ...
                        <label
                            class="switch switch-label switch-outline-secondary"
                        >
                            <input
                                class="switch-input"
                                type="checkbox"
                        ...
                        <label
                            class="switch switch-label switch-outline-success"
                        >
                            <input
                                class="switch-input"
                                type="checkbox"
                        ...
                        <label
                            class="switch switch-label switch-outline-warning"
                        >
                            <input
                                class="switch-input"
                                type="checkbox"
                        ...
                        <label
                            class="switch switch-label switch-outline-danger"
                        >
                            <input
                                class="switch-input"
                                type="checkbox"
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <label
                            class="
                                switch switch-label switch-outline-primary-alt
                            "
                        >
                            <input
                                class="switch-input"
                        ...
                        <label
                            class="
                                switch switch-label switch-outline-secondary-alt
                            "
                        >
                            <input
                                class="switch-input"
                        ...
                        <label
                            class="
                                switch switch-label switch-outline-success-alt
                            "
                        >
                            <input
                                class="switch-input"
                        ...
                        <label
                            class="
                                switch switch-label switch-outline-warning-alt
                            "
                        >
                            <input
                                class="switch-input"
                        ...
                        <label
                            class="switch switch-label switch-outline-info-alt"
                        >
                            <input
                                class="switch-input"
                                type="checkbox"
                        ...
                        <label
                            class="
                                switch switch-label switch-outline-danger-alt
                            "
                        >
                            <input
                                class="switch-input"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label
                                            class="
                                                switch switch-3d switch-primary
                                            "
                                        >
                                            <input
                                                class="switch-input"
