                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>
                                <button class="btn btn-brand btn-sm btn-facebook" type="button"
                                        style="margin-bottom: 4px">
                                    <i class="fa fa-facebook"></i>
                                    <span>Facebook</span>
                                </button>
                                <button class="btn btn-brand btn-sm btn-twitter" type="button"
                                        style="margin-bottom: 4px">
                                    <i class="fa fa-twitter"></i>
                                    <span>Twitter</span>
                                </button>
                                <button class="btn btn-brand btn-sm btn-linkedin" type="button"
                                        style="margin-bottom: 4px">
                                    <i class="fa fa-linkedin"></i>
                                    <span>LinkedIn</span>
                                </button>
                                <button class="btn btn-brand btn-sm btn-flickr" type="button"
                                        style="margin-bottom: 4px">
                                    <i class="fa fa-flickr"></i>
                                    <span>Flickr</span>
                                </button>
                                <button class="btn btn-brand btn-sm btn-tumblr" type="button"
                                        style="margin-bottom: 4px">
                                ...
                                <button class="btn btn-brand btn-sm btn-github" type="button"
                                        style="margin-bottom: 4px">
                                ...
                                <button class="btn btn-brand btn-sm btn-openid" type="button"
                                        style="margin-bottom: 4px">
                                    <i class="fa fa-openid"></i>
                                    <span>OpenID</span>
                                </button>
                                <button class="btn btn-brand btn-sm btn-stack-overflow" type="button"
                                        style="margin-bottom: 4px">
                                ...
                                <button class="btn btn-brand btn-sm btn-youtube" type="button"
                                        style="margin-bottom: 4px">
                                    <i class="fa fa-youtube"></i>
                                    <span>YouTube</span>
                                </button>
                                <button class="btn btn-brand btn-sm btn-dribbble" type="button"
                                        style="margin-bottom: 4px">
                                    <i class="fa fa-dribbble"></i>
                                    <span>Dribbble</span>
                                </button>
                                <button class="btn btn-brand btn-sm btn-google-plus" type="button"
                                        style="margin-bottom: 4px">
                                    <i class="fa fa-google-plus"></i>
                                    <span>Google+</span>
                                </button>
                                <button class="btn btn-brand btn-sm btn-instagram" type="button"
                                        style="margin-bottom: 4px">
                                    <i class="fa fa-instagram"></i>
                                    <span>Instagram</span>
                                </button>
                                <button class="btn btn-brand btn-sm btn-pinterest" type="button"
                                        style="margin-bottom: 4px">
                                ...
                                <button class="btn btn-brand btn-sm btn-dropbox" type="button"
                                        style="margin-bottom: 4px">
                                    <i class="fa fa-dropbox"></i>
                                    <span>Dropbox</span>
                                </button>
                                <button class="btn btn-brand btn-sm btn-reddit" type="button"
                                        style="margin-bottom: 4px">
                                    <i class="fa fa-reddit"></i>
                                    <span>Reddit</span>
                                </button>
                                <button class="btn btn-brand btn-sm btn-spotify" type="button"
                                        style="margin-bottom: 4px">
                                ...
                                <button class="btn btn-brand btn-sm btn-foursquare" type="button"
                                        style="margin-bottom: 4px">
                            ...
                            <p>
                                ...
                                <button class="btn btn-brand btn-stack-overflow" type="button"
                                        style="margin-bottom: 4px">
                                    <i class="fa fa-stack-overflow"></i>
                                    <span>StackOverflow</span>
                                </button>
                            ...
                            <p>
                                <button class="btn btn-brand btn-lg btn-facebook" type="button"
                                        style="margin-bottom: 4px">
                                    <i class="fa fa-facebook"></i>
                                    <span>Facebook</span>
                                </button>
                                <button class="btn btn-brand btn-lg btn-twitter" type="button"
                                        style="margin-bottom: 4px">
                                    <i class="fa fa-twitter"></i>
                                    <span>Twitter</span>
                                </button>
                                <button class="btn btn-brand btn-lg btn-linkedin" type="button"
                                        style="margin-bottom: 4px">
                                    <i class="fa fa-linkedin"></i>
                                    <span>LinkedIn</span>
                                </button>
                                <button class="btn btn-brand btn-lg btn-flickr" type="button"
                                        style="margin-bottom: 4px">
                                    <i class="fa fa-flickr"></i>
                                    <span>Flickr</span>
                                </button>
                                <button class="btn btn-brand btn-lg btn-tumblr" type="button"
                                        style="margin-bottom: 4px">
                                    <i class="fa fa-tumblr"></i>
                                    <span>Tumblr</span>
                                </button>
                                ...
                                <button class="btn btn-brand btn-lg btn-github" type="button"
                                        style="margin-bottom: 4px">
                                    <i class="fa fa-github"></i>
                                    <span>Github</span>
                                </button>
                                ...
                                <button class="btn btn-brand btn-lg btn-openid" type="button"
                                        style="margin-bottom: 4px">
                                    <i class="fa fa-openid"></i>
                                    <span>OpenID</span>
                                </button>
                                <button class="btn btn-brand btn-lg btn-stack-overflow" type="button"
                                        style="margin-bottom: 4px">
                                    <i class="fa fa-stack-overflow"></i>
                                    <span>StackOverflow</span>
                                </button>
                                ...
                                <button class="btn btn-brand btn-lg btn-youtube" type="button"
                                        style="margin-bottom: 4px">
                                    <i class="fa fa-youtube"></i>
                                    <span>YouTube</span>
                                </button>
                                <button class="btn btn-brand btn-lg btn-dribbble" type="button"
                                        style="margin-bottom: 4px">
                                    <i class="fa fa-dribbble"></i>
                                    <span>Dribbble</span>
                                </button>
                                <button class="btn btn-brand btn-lg btn-google-plus" type="button"
                                        style="margin-bottom: 4px">
                                    <i class="fa fa-google-plus"></i>
                                    <span>Google+</span>
                                </button>
                                <button class="btn btn-brand btn-lg btn-instagram" type="button"
                                        style="margin-bottom: 4px">
                                    <i class="fa fa-instagram"></i>
                                    <span>Instagram</span>
                                </button>
                                <button class="btn btn-brand btn-lg btn-pinterest" type="button"
                                        style="margin-bottom: 4px">
                                    <i class="fa fa-pinterest"></i>
                                    <span>Pinterest</span>
                                </button>
                                ...
                                <button class="btn btn-brand btn-lg btn-behance" type="button"
                                        style="margin-bottom: 4px">
                                    <i class="fa fa-behance"></i>
                                    <span>Behance</span>
                                </button>
                                <button class="btn btn-brand btn-lg btn-dropbox" type="button"
                                        style="margin-bottom: 4px">
                                    <i class="fa fa-dropbox"></i>
                                    <span>Dropbox</span>
                                </button>
                                <button class="btn btn-brand btn-lg btn-reddit" type="button"
                                        style="margin-bottom: 4px">
                                    <i class="fa fa-reddit"></i>
                                    <span>Reddit</span>
                                </button>
                                <button class="btn btn-brand btn-lg btn-spotify" type="button"
                                        style="margin-bottom: 4px">
                                    <i class="fa fa-spotify"></i>
                                    <span>Spotify</span>
                                </button>
                                ...
                                <button class="btn btn-brand btn-lg btn-foursquare" type="button"
                                        style="margin-bottom: 4px">
                                    <i class="fa fa-foursquare"></i>
                                    <span>Forsquare</span>
                                </button>
