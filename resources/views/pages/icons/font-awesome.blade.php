        ...
        <div class="card" id="new47">
            ...
            <div class="card-body">
                <div class="row text-center">
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <i
                            class="fa fa-thermometer-three-quarters fa-lg mt-4"
                        ></i>
                ...
                <div class="alert alert-success">
                    <ul class="fa-ul">
                        <li>
                            ...
                            work great with the <code>fa-spin</code> class.
                        </li>
                    </ul>
                </div>
                <div class="row text-center">
        ...
        <div class="card" id="brand">
            ...
            <div class="card-body">
                <div class="alert alert-warning">
                    ...
                    not use hacks to force them to display. Please
                    <a class="alert-link" href="https://adblockplus.org/en/bugs"
                        >report an issue with Adblock Plus</a
                    >
                    if you believe this to be an error. To work around this,
                    you'll need to modify the social icon class names.
                </div>
                <div class="row text-center">
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                ...
                <div class="alert alert-success mt-4">
                    <ul class="margin-bottom-none padding-left-lg">
                        ...
                        <li>
                            The use of these trademarks does not indicate
                            endorsement of the trademark holder by Font Awesome,
                            nor vice versa.
                        </li>
                        <li>
